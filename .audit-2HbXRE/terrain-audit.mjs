...
process.stdout.write(
  ...
  inside zone radii    ${snags.length - laneSnags.length}
`
);
...
var verdicts = [
  ...
  ["zones are snag-free", snags.length - laneSnags.length === 0, `${snags.length - laneSnags.length} refused steps`],
