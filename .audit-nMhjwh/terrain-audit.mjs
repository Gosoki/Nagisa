...
var PADS = [
   ...
   *
   * `inner` is 21 rather than 25 because the summit lane climbs past the terrace's northern
   * side at 14.4 m, about thirty metres out. Five metres of horizontal room cannot absorb
   * five and a half metres of rise however the blend is shaped, and the flat was claiming
   * ground it had no use for: the outermost thing on this terrace is the north gate at
   * r = 20. Giving the four metres back to the embankment costs nothing and takes the bank
   * across the street from 56° to walkable.
   */
  { id: "village", x: 64, z: -37, height: 9, inner: 21, outer: 37 },
...
var EMBANKMENT_GRADE_FRACTION = 0.72;
var maxEmbankmentGradient = 0;
